    ...
    useEffect(() => {
        ...
        const updateLineNumbers = () => {
            ...
            blockElements.forEach((element) => {
                ...
                const elementLineHeight = parseInt(elementStyle.lineHeight) ||
                    parseInt(elementStyle.fontSize) * 1.5;
                ...
                const elementContentHeight = element.getBoundingClientRect().height - paddingTop - paddingBottom;
                ...
                for (let i = 0; i < linesInElement; i++) {
                    ...
                    if (physicalLineIndex % frequency === 0 || physicalLineIndex === 1) {
                        ...
                        const displayNumber = type === 'arabic'
                            ? physicalLineIndex.toString()
                            : toRoman(physicalLineIndex);
            ...
            if (blockElements.length > 0) {
                ...
                const lastElementBottom = lastElement.offsetTop + lastElement.offsetHeight + lastElementMarginBottom;
