...
const IconArt_inlineWithText = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconArt_inlineWithText.displayName = 'IconArt_inlineWithText';

export default memo(IconArt_inlineWithText);
