...
const IconPrintSearch = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconPrintSearch.displayName = 'IconPrintSearch';

export default memo(IconPrintSearch);
