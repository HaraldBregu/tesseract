...
const IconAlignVertically = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconAlignVertically.displayName = 'IconAlignVertically';

export default memo(IconAlignVertically);
