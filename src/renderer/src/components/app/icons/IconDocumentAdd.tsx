...
const IconDocumentAdd = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconDocumentAdd.displayName = 'IconDocumentAdd';

export default memo(IconDocumentAdd);
