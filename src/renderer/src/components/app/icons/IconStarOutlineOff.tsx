...
const IconStarOutlineOff = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconStarOutlineOff.displayName = 'IconStarOutlineOff';

export default memo(IconStarOutlineOff);
