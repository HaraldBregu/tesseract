...
const IconPrintAdd = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconPrintAdd.displayName = 'IconPrintAdd';

export default memo(IconPrintAdd);
