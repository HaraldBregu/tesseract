...
const IconCitation = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>((props, ref) => {
    return (
...
IconCitation.displayName = 'IconCitation';

export default memo(IconCitation);
