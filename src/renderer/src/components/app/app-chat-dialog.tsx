...
const AppChatDialogContent = memo(
...
AppChatDialogContent.displayName = "AppChatDialogContent";
...
const AppChatDialogHeader = memo(
    ({ className, children, onDragStart, onDoubleClick, ...props }: DraggableDialogHeaderProps) => {
...
AppChatDialogHeader.displayName = "AppChatDialogHeader";

const AppChatDialog = memo(AppDialog);
const AppChatDialogFooter = memo(AppDialogFooter);

const AppChatDialogTitle = memo(
    forwardRef<
        React.ElementRef<typeof AppDialogTitle>,
        React.ComponentPropsWithoutRef<typeof AppDialogTitle>
    >(({ className, children, ...props }, ref) => {
        return (
            <AppDialogTitle ref={ref} className={cn("flex items-center gap-2", className)} {...props}>
                {children}
            </AppDialogTitle>
        );
    })
);
AppChatDialogTitle.displayName = "AppChatDialogTitle";

const AppChatDialogDescription = memo(AppDialogDescription);
