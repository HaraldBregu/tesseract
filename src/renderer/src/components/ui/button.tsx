  ...
  'inline-flex items-center justify-center gap-3 w-fit whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      ...
      variant: {
        ...
        icon: 'border border-transparent bg-transparent',
    ...
    compoundVariants: [
      {
        ...
        variant: 'filled',
        className:
          'bg-primary text-primary-foreground hover:bg-primary-40 disabled:bg-grey-65 disabled:text-grey'
      },
      {
        intent: 'primary',
        variant: 'outline',
        className:
          'border-primary text-primary hover:bg-primary-95 disabled:border-grey-60 disabled:text-grey'
      },
      {
        intent: 'primary',
        variant: 'tonal',
        className:
          'bg-primary-95 text-primary hover:bg-primary-90 disabled:bg-grey-65 disabled:text-grey'
      },
      {
        intent: 'secondary',
        variant: 'filled',
        className:
          'bg-secondary text-secondary-foreground hover:bg-secondary-40 disabled:bg-grey-65 disabled:text-grey'
      },
      {
        intent: 'secondary',
        variant: 'outline',
        className:
          'border-secondary text-secondary hover:bg-secondary-95 disabled:border-grey-60 disabled:text-grey'
      },
      {
        intent: 'secondary',
        variant: 'tonal',
      ...
      },
      {
        ...
        variant: 'outline',
        className:
          'border-destructive text-destructive hover:bg-destructive-95 disabled:border-grey-60 disabled:text-grey'
      },
      {
        intent: 'destructive',
        variant: 'tonal',
        className:
          'bg-destructive-95 text-destructive hover:bg-destructive-90 disabled:bg-grey-65 disabled:text-grey'
      },
      {
        intent: 'primary',
        variant: 'border',
      ...
      //icon variables
      {
        intent: 'primary',
        variant: 'icon',
        className: 'text-primary hover:bg-grey-80 disabled:text-grey'
      },
      {
        intent: 'secondary',
        variant: 'icon',
        className: 'text-secondary hover:bg-grey-80 disabled:text-grey'
      },
      {
        intent: 'destructive',
        variant: 'icon',
        className: 'text-destructive hover:bg-grey-80 disabled:text-grey'
      },
      // Link variants
      {
        intent: 'primary',
