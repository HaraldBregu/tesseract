...
import FormatTextColor from "./format-text-color";
import CustomSelect from "@/components/ui/custom-select";

// @ts-ignore
import { DEFAULT_LINE_SPACING, fontSizes, sectionTypes } from "../utils/optionsEnums";
...
import ListSquareBullet from "./icons/ListSquareBullet";
...
//@ts-ignore
type HIDE_GROUPS = 'SIDEBAR' | 'UNDO_REDO' | 'SECTION_STYLE' | 'FONT_FAMILY' | 'FONT_SIZE' | 'FONT_STYLE' | 'SPACING' | 'LINKING' | 'ALIGNMENT' | 'FIND_PREVIEW_MODE';

type OPTIONAL_ITEMS = 'SUPERSCRIPT' | 'SUBSCRIPT' | 'NON_PRINTING_CHARACTERS' | 'READING_SEPERATOR' | 'INNER_MARGIN' | 'OUTER_MARGIN' | 'SYMBOL' | 'OBJECT';
...
interface ToolbarProps {
  ...
  viewToolbar: boolean;
  sidebarOpen: boolean;
  includeOptionals?: OPTIONAL_ITEMS[];
...
const Toolbar: React.FC<ToolbarProps> = ({
  ...
  return (
    <ToolbarContainer className={viewToolbar ? '' : 'hidden'}>
      <div ref={toolbarContainer} id='test' className={cn("relative w-full max-w-full flex justify-between space-x-2 bg-white overflow-hidden")}>
        <div className="flex items-center space-x-2 flex-nowrap">
          ...
          >
            ...
            <CustomSelect
              ...
              value={emphasisState.headingLevel !== null ? emphasisState.headingLevel.toString() : ''}
              onValueChange={(value) => {
          ...
          >
            ...
            <CustomSelect
              ...
              value={emphasisState.fontSize ? emphasisState.fontSize.toString() : ''}
              onValueChange={(value) => {
          ...
          >
            ...
            {
              includeOptionals.includes('NON_PRINTING_CHARACTERS') &&
              <Button
                intent="secondary"
