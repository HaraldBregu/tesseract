...
export type HTMLManuscriptTextEditorElement = {
...
type ManuscriptTextEditorProps = {
    className?: string;
...
const ManuscriptTextEditor = forwardRef(({
    className,
    props,
    ...
    onUpdate,
    onSelectionUpdate,
}: ManuscriptTextEditorProps,
    ref: ForwardedRef<HTMLManuscriptTextEditorElement>) => {
...
export default memo(ManuscriptTextEditor)