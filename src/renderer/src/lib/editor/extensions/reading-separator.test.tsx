/**
 * Tests for ReadingSeparator TipTap Node extension
 */

import ReadingSeparator from './reading-separator';

describe('ReadingSeparator Node Extension', () => {
    const extension = ReadingSeparator;

    describe('configuration', () => {
        it('has correct name', () => {
            expect(extension.config.name).toBe('readingSeparator');
        });
