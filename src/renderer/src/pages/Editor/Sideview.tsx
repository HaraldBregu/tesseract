...
const Sideview = forwardRef(({
    ...
    const selectedBookmarkSL = useSelector(selectedBookmarkSelector)
    useEffect(() => {
    ...
    const bookmarkCategoriesMemo = useMemo(() => bookmarkCategories, [bookmarkCategories])
    ...
    const handleCreateBookmarkCategory = useCallback(() => {
        dispatch(addBookmarkCategory())
    }, [])

    const handleUpdateBookmarkCategory = useCallback((category: BookmarkCategory) => {
    ...
    const handleEditBookmark = useCallback(async (bookmark: Bookmark) => {
    ...
    const handleMoveBookmarkToCategory = useCallback((bookmark: Bookmark, category: BookmarkCategory | null) => {
    ...
    const handleClickBookmark = useCallback((bookmark: Bookmark) => {
                ...
                <SidebarContent className=" dark:bg-grey-20">
                    ...
                    {selectedTab === "bookmarks" &&
                        <AppBookmarks
                            ...
                            items={bookmarksMemo}
                            selectedBookmark={selectedBookmarkMemo}
                            onCreateCategory={(handleCreateBookmarkCategory)}
                            onUpdateCategory={handleUpdateBookmarkCategory}
                            onDeleteCategory={handleDeleteBookmarkCategory}
                            onEditBookmark={handleEditBookmark}
                            onDeleteBookmark={handleDeleteBookmark}
                            onMoveBookmarkToCategory={handleMoveBookmarkToCategory}
                            onClickBookmark={handleClickBookmark}
                        />
                    }

                    {/* Table of Contents */}
                    {selectedTab === "tableOfContents" &&
                        <TableOfContents
