    ...
    <Modal
      ...
      actions={
        <div className="flex flex-row gap-2">
          <Button variant="outline" size="small" onClick={() => setOpenModal(false)}>
            {t('pageSetup.component.customPaperSize.cancel')}
          </Button>
          <Button variant="filled" size="small" onClick={doneHdlr}>
            {t('pageSetup.component.customPaperSize.done')}
          </Button>
        </div>
      }
    >
