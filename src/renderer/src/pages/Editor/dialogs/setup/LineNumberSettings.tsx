...
interface LineNumberModalProps {
    ...
    onSave: (lineNumberSettings: LineNumberSettings) => void;
}

const LineNumberSettings = ({
    isOpen,
    setIsOpen,
    onSave,
}: LineNumberModalProps) => {
    ...
    const selectSectionLevel = useCallback(() => {
        return <Select
    ...
    }, [settings.linesNumeration, settings.sectionLevel]);

    useEffect(() => {
        const getLineNumberSettings = async () => {
            const lineNumberSettings = await window.doc.getLineNumberSettings();
            setSettings(prev => ({
                ...prev,
                ...lineNumberSettings
            }))
