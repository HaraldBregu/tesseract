...
import { ReferencesAction, setGuideColor } from "./ReferenceFormatAction";
import { useTranslation } from "react-i18next";
import { Label } from "@/components/ui/label";
import { guideColors, highlightColors } from "./ReferenceFormatConstants";
...
const GuideColors: React.FC<GuideColorsProps> = ({
    ...
    return (
        <>
            {/* <div className="bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded text-sm mr-4 mb-5" role="alert">
