...
export const separatorOptions = {
    lemma_separator: [
        { value: "", label: "referencesFormat.separator.none" },
...
export const highlightColors = [
    { key: "none", label: "referencesFormat.highlight.none", value: "transparent" },
...
export const SECTION_LEVELS = [
    ...
    { value: "6", label: "referencesFormat.sectionLevel.6" },
];

export const SEPARATOR_MIN_LENGTH = 1;
export const SEPARATOR_MAX_LENGTH = 3;

export const READING_TYPE_MIN_LENGTH = 1;
export const READING_TYPE_MAX_LENGTH = 10;