...
import { LayoutType } from "@/pages/editor/dialogs/setup/LayoutSetup/types";
...
const LayoutShape = ({
  ...
  const layouts = {
    "vertical-horizontal": `border flex flex-col [&>.c-apparatus]:flex-col`,
            ...
            {apparatusDetails.map((apparatus) => (
              ...
              >
                <TextPortion
                  ...
                  apparatus={apparatus}
                  additionalClassName={
                    (apparatusDetails.length > 2 && layoutName === 'vertical-vertical' && apparatus.title.length > 2)
