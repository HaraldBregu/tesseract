...
const MetadataView = () => {
  return (
    <div className="p-6 space-y-6 bg-white max-h-[70vh] overflow-y-auto">
      ...
      <MetadataItem
        title="Subject"
        value="Indicibvs variis, et novis, & appendice Pavli Lanceloti [...] adauctum [...] Accesservnt novissimè loci commvnes [...].
                "
      />
      ...
      <MetadataItem
        title="Keywords"
        value="Marriage, God, Legislation, Corpus iuris canonici 1140-1582"
      />
      ...
      <div className="p-6 space-y-6 bg-white max-h-[70vh] overflow-y-auto">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Indicibvs variis, et novis, & appendice Pavli Lanceloti [...] adauctum [...] Accesservnt
            novissimè loci commvnes [...].
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-600">
            Marriage, God, Legislation, Corpus iuris canonici 1140-1582
          </p>
        </div>
  ...
  return (
    <Modal
      ...
      actions={[
        ...
        <Button key="done" className="w-24" size="mini" intent="primary" onClick={() => {}}>
