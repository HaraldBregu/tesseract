    ...
    return (
        <Modal
            ...
            actions={[
                ...
                <Button key="save" disabled={!selectedSymbol && !selectedSpecialCharacter} className="border-none shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 w-24" size="mini" intent={"primary"} onClick={handleInsertCharacter}>
                    {t('buttons.insert')}
                </Button>
            ]}
        >
            <Tabs value={currentTab} defaultValue="symbols" className="w-full h-full overflow-hidden">
                ...
                <TabsContent value='symbols' className="max-h-[calc(100%-44px)] overflow-hidden flex flex-col focus-visible:ring-0 focus-visible:ring-offset-0">
                    <div className="mt-4 flex gap-4">
                        <div className="flex flex-col gap-1">
                            ...
                            <Select key="fontList" value={selectedFont} onValueChange={handleFontChange}>
                                <SelectTrigger id="fontList" className="w-[260px] focus:ring-0 focus:ring-offset-0 focus:border-grey-70">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <Select key="subsetList" value={selectedSubset} onValueChange={handleSubsetChange}>
                                <SelectTrigger id="subsetList" className="w-[240px] focus:ring-0 focus:ring-offset-0 focus:border-grey-70">
                    ...
                    <div className="mt-6 flex flex-wrap overflow-auto flex-1">
                        {filterSymbols.map(({ code }) => (
                            <AppButton
                                key={code}
                                variant={selectedSymbol === code ? "default" : "outline"}
                                size="icon"
                                rounded="none"
                                className="py-1 h-[50px] w-[50px] text-lg"
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className='border-t text-[11px] text-grey-10 leading-5'>
                                ...
                                {/* TODO Once we have proper requirement need to implement this */}
