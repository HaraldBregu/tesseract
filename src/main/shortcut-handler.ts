...
import { MenuItemId } from "./menu/menu";
...
const MENU_SHORTCUTS: ShortcutMapping[] = [
  ...
  { shortcut: 'CmdOrCtrl+2', menuItemId: MenuItemId.TEXT_SPACING_ONE_AND_HALF },
  { shortcut: 'CmdOrCtrl+3', menuItemId: MenuItemId.TEXT_SPACING_DOUBLE },
  { shortcut: 'CmdOrCtrl+4', menuItemId: MenuItemId.CUSTOM_SPACING },
